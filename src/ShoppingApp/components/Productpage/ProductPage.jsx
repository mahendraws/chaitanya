  ...
  return (
    <>
        ...
        <div>
          <div class="card-group ">
            <div class="card mx-3 Cart">
              <div class="card-body">
                <img
                  src="https://www.shrichyawanayurved.com/cdn/shop/files/Benefits_and_Ingredients-02_80e14ed7-bfbd-4ba7-950c-0ea11b89e37a.webp?v=1680317735&width=500"
                  class="card-img-top rounded-circle"
                  alt="..."
                />
                <h5 class="card-title text-center mt-2 mb-2">Card title</h5>
              </div>
            </div>
            <div class="card mx-3 Cart">
              <div class="card-body">
            ...
            <div class="card mx-3 Cart2">
              <div class="card-body">
                ...
                <h5 class="card-title text-center mt-2 mb-2">
                  <b>Aids in improving Thyroid status</b>
                </h5>
              </div>
            </div>
            <div class="card mx-3 Cart2">
      ...
      <div className="container mt-4 ProductsBox">
        ...
        <div>
          <p>
            <b>Product Description:</b> In quest to provide an ayurvedic thyroid
          ...
          <p>
            <b>Ingredients:</b> It contains ingredients like Trigonella Foenum,
